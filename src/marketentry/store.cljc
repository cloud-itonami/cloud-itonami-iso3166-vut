(ns marketentry.store
  "SSoT for the Republic of Vanuatu (VUT) market-entry compliance actor,
...
(defn demo-data
  ...
  `:claims-low-value-procurement?` / `:declared-contract-value` are
  ground truth for the `low-value-procurement-ineligible` flagship
  check (Government Contracts and Tenders Act [CAP. 245] s.3(2)/(4)
  VT 10,000,000 value threshold); `:requires-tax-clearance-record?` /
  `:tax-clearance-record-verified?` are ground truth for the
  conditional tax-clearance-record check (s.14(2)(e))."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Port Vila Trading Ltd" :portal "ctb.gov.vu/en/tenders/actual-tenders"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-low-value-procurement? false :declared-contract-value 20000000.0
             :requires-tax-clearance-record? true :tax-clearance-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "VUT" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "ctb.gov.vu/en/tenders/actual-tenders"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-low-value-procurement? false :declared-contract-value 20000000.0
             :requires-tax-clearance-record? true :tax-clearance-record-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Luganville Fabrication Co" :portal "ctb.gov.vu/en/tenders/actual-tenders"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "VUT" :status :intake}
    "eng-4" {:id "eng-4" :operator "Tanna Agri-Export Ltd" :portal "ctb.gov.vu/en/tenders/actual-tenders"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "VUT" :status :intake}
    "eng-5" {:id "eng-5" :operator "Malekula Supplies Cooperative" :portal "ctb.gov.vu/en/tenders/actual-tenders"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-low-value-procurement? false :declared-contract-value 20000000.0
             :requires-tax-clearance-record? true :tax-clearance-record-verified? false
             :drafted? false :submitted? false
             :jurisdiction "VUT" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               claims-low-value-procurement? declared-contract-value
                               requires-tax-clearance-record? tax-clearance-record-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? claims-low-value-procurement?) (assoc :engagement/claims-low-value-procurement? claims-low-value-procurement?)
    ...
    (some? tax-clearance-record-verified?) (assoc :engagement/tax-clearance-record-verified? tax-clearance-record-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/claims-low-value-procurement? :engagement/declared-contract-value
   :engagement/requires-tax-clearance-record? :engagement/tax-clearance-record-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :claims-low-value-procurement? (boolean (:engagement/claims-low-value-procurement? m))
     ...
     :tax-clearance-record-verified? (boolean (:engagement/tax-clearance-record-verified? m))
